...
/*!************************************************************************************************************!*\
  !*** /mnt/stuff/git/next-plugin-styled-components/node_modules/@babel/runtime-corejs2/core-js/date/now.js ***!
  \************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../next-plugin-styled-components/src/unstable-enhance-app-server.js":
/*!***************************************************************************!*\
  !*** ../next-plugin-styled-components/src/unstable-enhance-app-server.js ***!
  \***************************************************************************/
/*! no static exports found */
...
var _jsxFileName = "/mnt/stuff/git/next-plugin-styled-components/packages/next-plugin-styled-components/src/unstable-enhance-app-server.js";
...
module.exports = async function enhanceApp(ctx) {
  ...
  return App => props => ctx.sheets.collectStyles(__jsx(App, _extends({}, props, {
    __source: {
...
/***/ "../next-plugin-styled-components/src/unstable-get-styles-server.js":
/*!**************************************************************************!*\
  !*** ../next-plugin-styled-components/src/unstable-get-styles-server.js ***!
  \**************************************************************************/
/*! no static exports found */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _mnt_stuff_git_next_plugin_styled_components_packages_example_node_modules_explodingcamera_next_plugin_styled_components_src_unstable_enhance_app_server__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@explodingcamera/next-plugin-styled-components/src/unstable-enhance-app-server */ "../next-plugin-styled-components/src/unstable-enhance-app-server.js");
/* harmony import */ var _mnt_stuff_git_next_plugin_styled_components_packages_example_node_modules_explodingcamera_next_plugin_styled_components_src_unstable_enhance_app_server__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_mnt_stuff_git_next_plugin_styled_components_packages_example_node_modules_explodingcamera_next_plugin_styled_components_src_unstable_enhance_app_server__WEBPACK_IMPORTED_MODULE_0__);

    

    /* harmony default export */ __webpack_exports__["default"] = (function (ctx) {
      return Promise.all([_mnt_stuff_git_next_plugin_styled_components_packages_example_node_modules_explodingcamera_next_plugin_styled_components_src_unstable_enhance_app_server__WEBPACK_IMPORTED_MODULE_0___default()(ctx, {})])
    });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _mnt_stuff_git_next_plugin_styled_components_packages_example_node_modules_explodingcamera_next_plugin_styled_components_src_unstable_get_styles_server__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@explodingcamera/next-plugin-styled-components/src/unstable-get-styles-server */ "../next-plugin-styled-components/src/unstable-get-styles-server.js");
/* harmony import */ var _mnt_stuff_git_next_plugin_styled_components_packages_example_node_modules_explodingcamera_next_plugin_styled_components_src_unstable_get_styles_server__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_mnt_stuff_git_next_plugin_styled_components_packages_example_node_modules_explodingcamera_next_plugin_styled_components_src_unstable_get_styles_server__WEBPACK_IMPORTED_MODULE_0__);

    

    /* harmony default export */ __webpack_exports__["default"] = (function (ctx) {
      return Promise.all([_mnt_stuff_git_next_plugin_styled_components_packages_example_node_modules_explodingcamera_next_plugin_styled_components_src_unstable_get_styles_server__WEBPACK_IMPORTED_MODULE_0___default()(ctx, {})])
    });
  ...
  */
  static getInitialProps(ctx) {
    return (0, _asyncToGenerator2.default)(function* () {
      var enhancers =  true ? yield _promise.default.resolve().then(() => (0, _interopRequireWildcard2.default)(__webpack_require__(/*! next-plugin-loader?middleware=unstable-enhance-app-server */ "./node_modules/next/dist/build/webpack/loaders/next-plugin-loader.js?middleware=unstable-enhance-app-server!./"))).then(mod => mod.default(ctx)) : undefined;
      ...
      var styles = [...(0, _server.default)(), ...( true ? yield _promise.default.resolve().then(() => (0, _interopRequireWildcard2.default)(__webpack_require__(/*! next-plugin-loader?middleware=unstable-get-styles-server */ "./node_modules/next/dist/build/webpack/loaders/next-plugin-loader.js?middleware=unstable-get-styles-server!./"))).then(mod => mod.default(ctx)) : undefined)];
      return {
        html,
        head,
        styles
...
Document.headTagsMiddleware =  true ? _promise.default.resolve().then(() => (0, _interopRequireWildcard2.default)(__webpack_require__(/*! next-plugin-loader?middleware=document-head-tags-server */ "./node_modules/next/dist/build/webpack/loaders/next-plugin-loader.js?middleware=document-head-tags-server!./"))) : undefined;
Document.bodyTagsMiddleware =  true ? _promise.default.resolve().then(() => (0, _interopRequireWildcard2.default)(__webpack_require__(/*! next-plugin-loader?middleware=document-body-tags-server */ "./node_modules/next/dist/build/webpack/loaders/next-plugin-loader.js?middleware=document-body-tags-server!./"))) : undefined;
Document.htmlPropsMiddleware =  true ? _promise.default.resolve().then(() => (0, _interopRequireWildcard2.default)(__webpack_require__(/*! next-plugin-loader?middleware=document-html-props-server */ "./node_modules/next/dist/build/webpack/loaders/next-plugin-loader.js?middleware=document-html-props-server!./"))) : undefined;
